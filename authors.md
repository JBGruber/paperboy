...
- **Sina Chen**. Author. [](https://orcid.org/0000-0001-9359-4458)
...
Source:
[`DESCRIPTION`](https://github.com/JBGruber/paperboy/blob/main/DESCRIPTION)

Gruber J, Chen S (2026). *paperboy: A Comprehensive Collection of News
Media Scrapers*. R package version 0.0.7.9000,
<https://github.com/JBGruber/paperboy>.

    @Manual{,
      title = {paperboy: A Comprehensive Collection of News Media Scrapers},
      author = {Johannes B. Gruber and Sina Chen},
      year = {2026},
