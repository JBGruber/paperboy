...
#> ✔ Looking through links on the main page [291ms]
#> 
#> ℹ Looking through common paths on the site
#> ✔ Looking through common paths on the site [463ms]
#> 
#> ℹ Querying feedly API
#> ✔ Querying feedly API [482ms]
#> 
...
#> 7 feedly API       https://www.buzzfeed.com/badge/omg
```
